...
<body class="bg-gray-100">
    <div class="flex">
        ...
        <div class="bg-blue-800 text-white w-64 min-h-screen p-4">
            ...
            <ul>
                <li class="mb-4">
                    <a href="{{ route('enseignant.dashboard1') }}" class="block py-2 px-4 hover:bg-blue-700 {{ request()->routeIs('enseignant.dashboard1') ? 'bg-blue-900' : '' }}">
                        Tableau de bord
                    </a>
                </li>
                <li class="mb-4">
...
<!-- Nombre d'étudiants -->
<a href="{{ route('enseignant.etudiants.index') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
...
<a href="{{ route('enseignant.emplois.index') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
    ...
    <p class="text-4xl font-bold text-green-600">{{ $nombreEmplois ?? 0 }}</p>
            ...
            <div class="flex space-x-4">
                ...
                <form action="{{ route('enseignant.logout') }}" method="POST">
                    @csrf
